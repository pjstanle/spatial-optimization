...
if __name__=="__main__":
    ...
    turbine = 3 # 1: low 2: meduim 3: high
    setback_mult = 1.1 # float
    objective = "coe" # coe or profit
    ppa_mult = 0.0
    ...
    nturbs = np.zeros(len(turbine_x),dtype=int)
    coe_array[0] = start_obj
    nturbs[0] = len(turbine_x)

    for j in range(nturbs[0]-1):
